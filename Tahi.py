...
logo =                                          """            
MMP""MM""YMM   db      `7MN.   `7MF'`7MMF'  `7MMF'      db      
P'   MM   `7  ;MM:       MMN.    M    MM      MM       ;MM:     
     MM      ,V^MM.      M YMb   M    MM      MM      ,V^MM.    
     MM     ,M  `MM      M  `MN. M    MMmmmmmmMM     ,M  `MM    
     MM     AbmmmqMA     M   `MM.M    MM      MM     AbmmmqMA   
     MM    A'     VML    M     YMM    MM      MM    A'     VML  
   .JMML..AMA.   .AMMA..JML.    YM  .JMML.  .JMML..AMA.   .AMMA.
                                                                
                                                                

\033[1;37m------------------------------------------------
\033[1;37m Owner   :             TAHI
\033[1;37m Facebook:          SETEVEN
\033[1;37m Github  :              TAHI
\033[1;37m Version :             20.00
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
